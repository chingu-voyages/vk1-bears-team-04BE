            ...
            <div className="mt-8 sm:mt-0 sm:w-full sm:px-4 flex flex-col md:flex-row justify-between">
              ...
              <div className="w-full py-2 flex flex-col">
                ...
                <span className="text-justify px-2">
                  ...
                  wanted to reach someone for help to provide informations by
                  filling up a rescue form. With the support from U Rescue Me,
                  rescuers can easily gather the required information. This
                  application can also be used by non-emergency services that
                  need to gather crowd intelligence in a search operation.
                </span>
              </div>
