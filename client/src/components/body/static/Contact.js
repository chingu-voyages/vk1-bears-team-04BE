      ...
      <div>
        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="px-10 pb-10">
            ...
            <textarea class="w-full h-32" placeholder="Message"></textarea>
        ...
        <div className="flex-col md:flex-row flex gap-5 px-10 pt-10 pb-14 justify-center">
          <div className="border-2 border-yellow-300 rounded-3xl p-5 md:w-96">
            ...
            <p className="text-center">
              ...
              <a
                href="https://www.google.com/maps/place/Metro+Manila/data=!4m2!3m1!1s0x3397c8d26026386d:0x5fed23daac9278d0?sa=X&ved=2ahUKEwi9___hs4XuAhVMG6YKHdEjBQkQ8gEwFXoECCwQAQ"
          ...
          <div className="border-2 border-yellow-300 rounded-3xl p-5 md:w-96">
            ...
            <p className="text-center">
              ...
              <a
                className="font-semibold"
                href="mailto:urescueme.info@gmail.com"
              >
                urescueme.info@gmail.com
              </a>
              .
            </p>
          </div>
